...
import {
  SysRenderTextured,
  SysRenderMirror,
  SysRenderMeshesWithLight,
} from "./mesh_render.js";

import { create_choice_menu } from "./menu.js";
import {
  create_scene_content_reflections,
  create_scene_content_shadows,
  load_resources,
} from "./scene.js";
...
async function main() {
  ...
  canvas_elem.addEventListener("wheel", (event) => {
    ...
    frame_info.cam_distance_factor = Math.max(
      0.02,
      Math.min(frame_info.cam_distance_factor, 4)
    );
